            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder"><?=$shorttitle?></span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Chào mừng bạn!👋</h4>
              <p class="mb-4">Vui lòng đăng ký để sử dụng hệ thống fake bill</p>
<?php
...
?>
 ...
 <?php endif; ?>
              <form id="formAuthentication" class="mb-3" action="" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-success d-grid w-100" type="submit">Đăng ký tài khoản</button>
                </div>
              </form>
